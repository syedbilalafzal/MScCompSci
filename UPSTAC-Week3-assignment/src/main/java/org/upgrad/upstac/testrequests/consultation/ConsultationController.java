...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        // Return list of completed lab tests
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        // create doctor object to store currently logged in doctor
        User doctor = userLoggedInService.getLoggedInUser();

        // Return list of test requests assigned to the doctor
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            ...
            // Assign test request to doctor and store the assigned request to the object
            TestRequest assignedRequest = testRequestUpdateService.assignForConsultation(id,doctor);
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            // Create an object to hold the current logged in user.
            User doctor = userLoggedInService.getLoggedInUser();

            // Update the database with the doctor's comments and status.
            TestRequest doctorUpdate = testRequestUpdateService.updateConsultation(id,testResult, doctor);

            // Return it to payload
            return doctorUpdate;
